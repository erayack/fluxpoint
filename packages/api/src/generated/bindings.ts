...
export type TargetCircuitState = {
  endpoint_id: string;
  state: TargetCircuitStatus;
...
export type WebhookAttemptLog = {
  ...
  error_kind: WebhookAttemptErrorKind | null;
  error_message: string | null;
};

export type WebhookAttemptErrorKind = "timeout" | "network" | "invalid_response" | "unexpected";

export type ReportResponse = { circuit: TargetCircuitState | null };
...
export type LeasedEvent = {
  event: WebhookEvent;
  target_url: string;
  lease_expires_at: string;
  circuit: TargetCircuitState | null;
};
